...
<div class="container text-dark">
    ...
    <div class="container text-center">
        <h2 class="text-secondary mx-4 border-bottom"><span class="text-dark fw-bold"> <i class="fa-solid fa-plate-utensils"></i> Our Meals</h2>
        <div class="input-group mx-4">
            <form action="dashboard/search" method="GET" class="form-outline d-flex w-50 m-auto p-3">
...
<div class="container d-flex justify-content-around text-center" style="flex-wrap:wrap"> 
    ...
    <div class="card card-body bg-light center-block text-left rounded mx-3 bg-muted m-3 text-dark" style="min-width:26%;max-width:30%" >
        ...
        <p class="border-bottom fw-bold p-1"> {{$meal->description}} Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, id.</p>
    ...
    <span class="container d-flex align-items-center justify-content-center">{{$meals->links('pagination::bootstrap-4')}}</span>
</div>
@endsection